...
public class ComputerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        computerViewModel =
                ViewModelProviders.of(this).get(ComputerViewModel.class);
        View root = inflater.inflate(R.layout.fragment_computer, container, false);
        final TextView textView = root.findViewById(R.id.text_computer);
        computerViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
